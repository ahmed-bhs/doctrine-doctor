...
<div class="suggestion-content">
    ...
    <div class="alert alert-warning">
        <code><?= $fieldName ?></code> has a public setter. This allows bypassing audit controls and tampering with historical records.
    </div>

    <p>The creator/author should be set once and never changed. Public setters break audit trail integrity.</p>
    ...
    <pre><code class="language-php">class <?= basename(str_replace('\\', '/', $entityClass)) . "\n" ?>
{
    ...
    <p>Remove the setter. Set in constructor so it's immutable after creation.</p>
</div>
