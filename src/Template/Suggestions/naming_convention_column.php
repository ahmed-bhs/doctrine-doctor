...
<div class="suggestion-header">
    ...
    <h4>Fix Column Naming Convention</h4>
</div>

<div class="suggestion-content">
    <div class="alert alert-warning">
        <strong>Column naming convention violation detected.</strong>
    </div>

    <h4>Current</h4>
    <div class="query-item">
        <pre><code class="language-php">class <?php echo $e($entityClass); ?> {
    #[ORM\Column(name: '<?php echo $e($current); ?>')]
    ...
    <h4>Column conventions</h4>
    <ul>
        <li>snake_case (first_name, created_at, is_active)</li>
        <li>Lowercase only</li>
        <li>Use underscores to separate words</li>
        <li>Avoid SQL reserved keywords</li>
    </ul>
