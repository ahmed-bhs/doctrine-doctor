...
class IntegrityIssue extends AbstractIssue
{
    ...
    public static function supportedTypes(): array
    {
        return [
            ...
            IssueType::DISCRIMINATOR_COLUMN_TOO_SHORT->value,
            IssueType::DISCRIMINATOR_COLUMN_NOT_INDEXED->value,
            IssueType::NULLABLE_PRIMARY_KEY->value,
            IssueType::STRING_DEFAULT_EXPRESSION->value,
