...
final class PaginatorQueryDetectorTest extends TestCase
{
    ...
    public function it_detects_orm_offset_paginator_in_backtrace(): void
    {
        ...
        $backtrace = [
            ['file' => '/app/vendor/doctrine/orm/src/AbstractQuery.php', 'line' => 724, 'class' => \Doctrine\ORM\AbstractQuery::class, 'function' => 'getScalarResult'],
            ['file' => '/app/vendor/doctrine/orm/src/Tools/Pagination/OffsetPaginator.php', 'line' => 89, 'class' => \Doctrine\ORM\Tools\Pagination\OffsetPaginator::class, 'function' => 'paginate'],
        ];
    ...
    public function it_detects_orm_cursor_paginator_in_backtrace(): void
    {
        ...
        $backtrace = [
            ['file' => '/app/vendor/doctrine/orm/src/AbstractQuery.php', 'line' => 724, 'class' => \Doctrine\ORM\AbstractQuery::class, 'function' => 'getScalarResult'],
            ['file' => '/app/vendor/doctrine/orm/src/Tools/Pagination/CursorPaginator.php', 'line' => 154, 'class' => \Doctrine\ORM\Tools\Pagination\CursorPaginator::class, 'function' => '{closure}'],
            ['file' => '/app/vendor/doctrine/orm/src/Tools/Pagination/CursorPage.php', 'line' => 79, 'class' => \Doctrine\ORM\Tools\Pagination\CursorPage::class, 'function' => 'getTotalCount'],
        ];
