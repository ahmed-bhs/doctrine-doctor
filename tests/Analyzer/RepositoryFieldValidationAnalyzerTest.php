...
use AhmedBhs\DoctrineDoctor\Analyzer\RepositoryFieldValidationAnalyzer;
...
/**
 * Test for RepositoryFieldValidationAnalyzer.
 *
 ...
 * - Integration tests in tests/Integration/Analyzer/RepositoryFieldValidationAnalyzerIntegrationTest.php
 *
 ...
 */
final class RepositoryFieldValidationAnalyzerTest extends TestCase
{
    private RepositoryFieldValidationAnalyzer $analyzer;

    protected function setUp(): void
    {
        $entityManager = PlatformAnalyzerTestHelper::createTestEntityManager();

        $this->analyzer = new RepositoryFieldValidationAnalyzer(
            $entityManager,
